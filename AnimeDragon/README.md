...
## Automação 2026
A versão atual possui descoberta automática via AniList, atualização de metadados/capas, criação automática de categorias, detecção de duplicados, Cron a cada 6 horas e painel de automação.
